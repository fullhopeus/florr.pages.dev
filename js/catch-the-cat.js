            ...
            return (
                    ...
                    set: function (t) {
                        switch (t) {
                            ...
                            case i.LOSE:
                                this.setStatusText(
                                    f.default(
                                        "The cat has run out of the map. You lost."
                                    )
                                );
                                break;
                            case i.WIN:
                                this.setStatusText(
                                    f.default(
                                        "The cat has no way to go. You win!"
                                    )
                                );
                                break;
                            default:
                ...
                (e.prototype.playerClick = function (t, e) {
                    if (
                        ...
                        return (
                            this.setStatusText(f.default("Game Over,Restart")),
                            this.reset(),
                            !1
                        );
                    ...
                    return n
                        ? n.isWall
                            ? (this.setStatusText(
                                  f.default(
                                      "Already a wall, it is forbidden to click."
                                  )
                              ),
                              !1)
                            ...
                            ? (this.setStatusText(
                                  f.default(
                                      "The location of the cat, forbidden to click."
                                  )
                              ),
                              !1)
                            : ((n.isWall = !0),
                              this.cat.isCaught()
                                  ? (this.setStatusText(
                                    ...
                                    !1)
                                  : (this.setStatusText(
                                        f.default("You have been pressed ") +
                                            "(" +
                                            t +
                                            ", " +
                                            e +
                        ...
                        : (this.setStatusText(
                              f.default(
                                  "The code is wrong, the current location does not exist."
                              )
                          ),
                          !1);
                }),
                (e.prototype.reset = function () {
                    this.cat.reset(),
                        ...
                        this.setStatusText(
                            f.default(
                                "Click the polka dot to surround the kitten."
                            )
                        );
                }),
            ...
            l = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.isCaught = function () {
                        var t = this;
                        return !this.getCurrentNeighbours().some(
                            function (e, n) {
        ...
        var i = (function (t) {
            function e(e, n, o, r) {
                var i = this,
                    s = e.getPosition(n, o);
                ((i =
                    t.call(this, e, s.x, s.y, r, 0, 360, !1, 0, 1) || this).i =
                    n),
                    (i.j = o),
                    (i.r = r),
                    (i.isWall = !1);
    ...
    function (t, e, n) {
        ...
        var i = n(2),
            s = (function (t) {
                function e(e) {
                    var n =
                        t.call(this, e, 0, 0, i.default("Restart"), {}) || this;
                    n.setColor("#000000");
                    var o = e.r;
                    n.setFontSize(o),
                    ...
                    return (
                        n.setInteractive(r, Phaser.Geom.Rectangle.Contains), n
                    );
                }
                return r(e, t), e;
